...
miscopts=( complete_in_word  complete_aliases prompt_subst transient_rprompt menu_complete complete_in_word always_to_end auto_pushd pushd_ignore_dups interactive_comments)
